			...
			<div class="menu">
				...
				<nav class="nav">
					<ul class="list">
						...
						<li class="item">
							<router-link class="link" :to="{ name: 'suppliers' }">Suppliers</router-link>
						</li>
						<li class="item">
							<router-link class="link" :to="{ name: 'contacts' }">Contacts</router-link>
						</li>
						<li class="item">
							<router-link class="link" :to="{ name: 'rules' }">Rules</router-link>
						</li>
						<li class="item">
							<router-link class="link" :to="{ name: 'selector' }">Selector</router-link>
						</li>
						<li class="item">
							<router-link class="link" :to="{ name: 'editor' }">Editor</router-link>
						</li>
					</ul>
				</nav>
			</div>
